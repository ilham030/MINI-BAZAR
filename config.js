...
const CONFIG = {
    ...
    STORE_CURRENCY: "AZN",
    STORE_ADDRESS: "Bakı, Azərbaycan",
    STORE_HOURS: "Hər gün: 09:00 - 21:00",
    FREE_DELIVERY_THRESHOLD: 150,
    // Sosial media linklərini özünüzünkü ilə əvəz edin
    SOCIAL: {
        instagram: "#",
        facebook: "#"
    }
...
//   rating       -> 1-5 arası real reytinq (yoxdursa sahəni əlavə etməyin, ulduzlar göstərilməyəcək)
//   reviewCount  -> real rəy sayı
const PRODUCTS = [
    {
        id: 1,
        name: "İphone 17 pro",
